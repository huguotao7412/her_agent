...
TIPS = [
    ...
    "hermes config set KEY VALUE auto-routes secrets to .env and everything else to cli-config.yaml.",
    "hermes config edit opens cli-config.yaml in your default editor.",
    ...
    "Set worktree: true in cli-config.yaml to always create a git worktree (same as hermes -w).",
