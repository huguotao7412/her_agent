...
Skins are defined as YAML files in ~/.her_agent/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from her_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.her_agent/skins/
...
Drop a YAML file in ``~/.her_agent/skins/<name>.yaml`` following the schema above.
