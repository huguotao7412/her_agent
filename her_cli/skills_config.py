...
`her_agent skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.her_agent/cli-config.yaml under:
...
from her_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `her_agent skills`."""
    from her_cli.curses_ui import curses_checklist
