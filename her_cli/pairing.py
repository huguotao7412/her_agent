...
Usage:
    her_agent pairing list              # Show all pending + approved users
    her_agent pairing approve <platform> <code>  # Approve a pairing code
    her_agent pairing revoke <platform> <user_id> # Revoke user access
    her_agent pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle her_agent pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: her_agent pairing {list|approve|revoke|clear-pending}")
        print("Run 'her_agent pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'her_agent pairing list' to see pending codes.\n")
