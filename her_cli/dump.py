"""
Dump command for her_agent CLI.
...
from her_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _gateway_status() -> str:
    ...
    try:
        from her_cli.gateway import get_gateway_runtime_snapshot
...
def run_dump(args):
    ...
    toolsets = config.get("toolsets", ["her_agent-cli"])
