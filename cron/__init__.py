...
Cron jobs are executed automatically by the gateway daemon:
    her_agent gateway install    # Install as a user service
    sudo her_agent gateway install --system  # Linux servers: boot-time system service
    her_agent gateway            # Or run in foreground
